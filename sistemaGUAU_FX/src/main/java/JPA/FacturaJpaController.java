...
public class FacturaJpaController implements Serializable {
    ...
    public void create(Factura factura) {
        ...
        try {
            ...
            Usuario usuarioid = factura.getUsuarioid();
            if (usuarioid != null) {
            ...
            if (usuarioid != null) {
                usuarioid.getFacturaList().add(factura);
    ...
    public void edit(Factura factura) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Usuario usuarioidOld = persistentFactura.getUsuarioid();
            Usuario usuarioidNew = factura.getUsuarioid();
            ...
            if (usuarioidNew != null) {
                ...
                factura.setUsuarioid(usuarioidNew);
            }
            ...
            if (usuarioidOld != null && !usuarioidOld.equals(usuarioidNew)) {
                usuarioidOld.getFacturaList().remove(factura);
                usuarioidOld = em.merge(usuarioidOld);
            }
            if (usuarioidNew != null && !usuarioidNew.equals(usuarioidOld)) {
                usuarioidNew.getFacturaList().add(factura);
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            Usuario usuarioid = factura.getUsuarioid();
            if (usuarioid != null) {
                usuarioid.getFacturaList().remove(factura);
                usuarioid = em.merge(usuarioid);
            }
            em.remove(factura);
            em.getTransaction().commit();
