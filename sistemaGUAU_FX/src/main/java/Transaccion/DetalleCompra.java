...
public class DetalleCompra implements Serializable {
    ...
    @JoinColumn(name = "Recibo_id", referencedColumnName = "idRecibo")
    @ManyToOne(optional = false)
    private ReciboCompra reciboid;
    ...
    public DetalleCompra(Integer id, int cantidad, float subtotal) {
        this.id = id;
    ...
    public ReciboCompra getReciboid() {
        return reciboid;
    }

    public void setReciboid(ReciboCompra reciboid) {
    ...
    public String toString() {
        return "Transaccion.DetalleCompra[ id=" + id + " ]";
    }
